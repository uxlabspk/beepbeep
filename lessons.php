...
<html lang="en-GB">
  <head>
    ...
    <title>Driving Courses | Beep Beep Driving School - Learn to Drive</title>
        ...
        >
          ...
          <div>
            ...
            <ul class="space-y-3 text-gray-400 text-sm">
              <li>
                <a href="#beginners" class="hover:text-brand transition-colors"
                  >Beginner Lessons</a
                >
              </li>
              <li>
                <a href="#refresher" class="hover:text-brand transition-colors"
                  >Refresher Courses</a
                >
              </li>
              <li>
                <a href="#test-prep" class="hover:text-brand transition-colors"
                  >Test Preparation</a
                >
              </li>
              <li>
                <a href="#manual" class="hover:text-brand transition-colors"
                  >Manual Driving</a
                >
              </li>
              <li>
                <a href="#automatic" class="hover:text-brand transition-colors"
                  >Automatic Driving</a
                >
              </li>
              <li>
                <a href="#intensive" class="hover:text-brand transition-colors"
                  >Intensive Courses</a
                >
              </li>
            </ul>
