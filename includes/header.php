          ...
          <?php if (isLoggedIn()): ?>
            ...
            <li>
              <a
                ...
                class="text-brand text-xl font-medium hover:text-brand-dark transition-colors"
                >Admin Panel</a
              >
            </li>
            <?php endif; ?>
          ...
          <?php if (isLoggedIn()): ?>
            ...
            <div class="relative" id="userMenu">
              ...
              >
                ...
                <a
                  href="/admin/index.php"
                  class="flex items-center gap-3 px-4 py-3 text-sm text-brand hover:bg-brand/5 transition-colors"
                >
